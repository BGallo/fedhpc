...
PYBIND11_MODULE(_moea, m) {
    ...
    m.def("nsga2",
        [](int n_jobs, double budget,
           ...
           int local_search_interval, int sched_repair) {
            auto [results, prof] = run_nsga2(
                ...
                tourn_k, local_search_interval, sched_repair);
        ...
        [](int n_jobs, double budget,
           ...
           int local_search_interval, int sched_repair) {
            auto [results, prof] = run_nsga3(
                ...
                crossover_kind, tourn_k, local_search_interval, sched_repair);
            return py::make_tuple(results, profile_to_dict(prof));
        },
        py::arg("n_jobs"),
        py::arg("budget"),
        ...
        [](int n_jobs, double budget,
           ...
           int ls_moves, int restart_patience, int shortlist) {
            auto [asgn, f1, f2, g, ls_calls] = run_weighted(
                ...
                ls_moves, restart_patience, shortlist);
